...
def main():
    ...
    parser.add_argument('--output_path', type=str, default='/data/haixin/mmr/EMMA/results/EMMA-reimplement/open-source')
    ...
    # Remote model
    parser.add_argument('--model', type=str, default='Qwen2.5-VL-72B-Instruct', help='remote llm engine',
                        choices=['chatgpt-4o-latest','Qwen2.5-VL-72B-Instruct', 'grok-2-vision-latest', 'claude-3-5-sonnet-latest', 'gemini-2.0-flash-exp','gemini-2.0-flash-thinking-exp-1219','OpenGVLab/InternVL2_5-78B'])
    ...
    if args.model_path:
        ...
        if 'internvl' in args.model_path.lower():
            ...
            model = internvl.Internvl_Model(args.model, args.model_path, temperature=args.temperature, max_tokens=args.max_tokens)
        ...
        if 'gpt' in args.model.lower():
            ...
            model = grok.Grok_Model(client, args.model, temperature=args.temperature, max_tokens=args.max_tokens)
    ...
    args.output_path = os.path.join(args.output_path,args.model+'.json')
