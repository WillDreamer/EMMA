...
def main():
    ...
    # Remote model
    parser.add_argument('--model', type=str, default='grok-2-vision-latest', help='remote llm engine',
                        choices=['chatgpt-4o-latest', 'grok-2-vision-latest', 'claude-3-5-sonnet-latest', 'gemini-2.0-flash-exp','gemini-2.0-flash-thinking-exp-1219','OpenGVLab/InternVL2_5-78B'])
