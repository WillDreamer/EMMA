...
def main():
    ...
    # Remote model
    parser.add_argument('--model', type=str, default='Qwen/Qwen2.5-VL-72B-Instruct', help='remote llm engine',
                        choices=['chatgpt-4o-latest', 'Qwen/Qwen2.5-VL-72B-Instruct','Qwen/Qwen2.5-VL-7B-Instruct','deepseek-ai/DeepSeek-R1-Distill-Qwen-14B', 'grok-2-vision-latest', 'claude-3-5-sonnet-latest', 'gemini-2.0-flash-exp','gemini-2.0-flash-thinking-exp-1219'])
    parser.add_argument('--api_key', type=str, default='')
    # Local model
    parser.add_argument('--model_path', type=str, default='Qwen/Qwen2.5-VL-72B-Instruct', help="local model path or huggingface model name")
    ...
    from models import qwen_2_5
    model = qwen_2_5.GPT_Model(client, args.model, temperature=args.temperature, max_tokens=args.max_tokens)
