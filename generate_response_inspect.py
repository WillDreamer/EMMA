...
def main():
    ...
    from models import qwen_2_5_inspect
    ...
    model = qwen_2_5_inspect.GPT_Model(client, llm_client, args.model, \
            temperature=args.temperature, \
            max_tokens=args.max_tokens)

    logging.info(f"Model loaded!")

    args.output_path = os.path.join(args.output_path,args.model+'_pre_inspect_32B.json')
