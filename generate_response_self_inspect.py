...
def main():
    ...
    # llm_api_key = "EMPTY"
    # llm_api_base = "http://localhost:8002/v1"
    # llm_client = OpenAI(
    #     api_key=llm_api_key,
    #     base_url=llm_api_base,
    # )
    llm_client = None
    from models import qwen_2_5_self_inspect
    model = qwen_2_5_self_inspect.GPT_Model(client, llm_client, args.model, \
            temperature=args.temperature, \
            max_tokens=args.max_tokens)

    logging.info(f"Model loaded!")

    args.output_path = os.path.join(args.output_path,args.model+'_self_inspect.json')
